...
from utils import *
from models.DBUnet import DBUNet
...
class setting_config:
    ...
    datasets = 'BUSI'
    data_path = r'D:\zzm\DBUNet\data\BUSI/'
    # if datasets == 'DDTI':
    #     data_path = r'D:\zzm\DBUNet\data\DDTI'
    # if datasets == 'NEWDDTI':
    #     data_path = r'D:\zzm\DBUNet\data\NEWDDTI'
    # if datasets == 'SUI':
    #     data_path ='./data/SUI/'
    # if datasets == 'Bbenign':
    #     data_path = r'D:\zzm\DBUNet\data\B-benign/'
    # if datasets == 'Bmalign':
    #     data_path = r'D:\zzm\DBUNet\data\B-malign/'
    # elif datasets == 'BUSI':
    #     data_path = r'D:\zzm\DBUNet\data\BUSI/'
    # else:
    #     raise Exception('datasets in not right!')
    def loss(device):
        model = DBUNet().to(device)  # 将模型移动到指定设备
        criterion = BceDiceLoss(model=model, device=device, wb=0.5, wd=1, wl2=1e-4)  # 确保正确传递设备参数
        return criterion
